...
|---|------|----------|-----|----------|---------|--------|--------|
| 1 | 2026-07-19 | Code Smells | P2 | settings_ui.py → SettingsWindow | ~1300-line file, well over the ~500-line guideline; candidate to split into per-page modules (General/Whisper/Audio/Overlay/Integrations/Assistant/History/Help) | Deferred | Optimizer setup |
