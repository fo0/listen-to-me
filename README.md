...
- **Floating status icon** — a small animated always-on-top icon you can drag
  ...
  while there is one to cancel. Hovering
...
- **Transcript history** — the transcribed text of each recording is kept
  ...
  search field), bounded in size, and easy to switch off or
...
| **History**      | Recent **transcribed text** kept locally (never the audio), each with a **Copy** button so a lost transcript can be recovered and a **Delete** button that removes just that one entry; a **search field** (`Ctrl+F`) narrows the list to the transcripts containing your words (any order, case-insensitive) and shows how many of them matched; **Export…** writes the listed transcripts (the search filter applies) to a text file; toggle history on/off, how many entries to keep, and **Clear history**                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
