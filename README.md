...
- **Transcript history** — the transcribed text of each recording is kept
  ...
  its own, without losing the rest.
...
| **History**      | Recent **transcribed text** kept locally (never the audio), each with a **Copy** button so a lost transcript can be recovered and a **Delete** button that removes just that one entry; a **search field** narrows the list to the transcripts containing your words (any order, case-insensitive) and shows how many of them matched; toggle history on/off, how many entries to keep, and **Clear history**                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
