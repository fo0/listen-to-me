...
- **Optional assistant post-processing** — pipe the transcript through any
  ...
  the prompt, because nothing else keeps a copy of what you wrote).
...
| **Assistant**    | Enable/disable, API base URL, model, API key, temperature, **request timeout** (how long a dictation is held back waiting for the answer), **Test connection** (sends one sample sentence and shows the reply — verifies the endpoint before a dictation depends on it, with a **Cancel** button so a wrong URL or a stopped endpoint doesn't hold the page for the whole request timeout), **system prompt** (editable, with _Reset to default…_ — it asks first once you have edited the prompt, since nothing else keeps a copy of what you wrote)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
