...
| **Assistant**    | Enable/disable, API base URL, model, API key, temperature, **Test connection** (sends one sample sentence and shows the reply — verifies the endpoint before a dictation depends on it), **system prompt** (editable, with _Reset to default_)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
