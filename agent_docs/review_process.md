...
| --- | ---------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1   | **Can I name file and line?**                                                      | A finding that cannot be located cannot be acted on. "Somewhere in the overlay code" is a hunch with a category attached                                          |
...
| 3   | **Did I read the surrounding context — callers, imports, the selftest checks?**    | Most apparent defects are already handled one frame up or made impossible by a guard. Reporting without looking spends the author's time to save the reviewer's   |
