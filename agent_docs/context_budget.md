...
| 2   | Env vars beyond the 3 the agent must know; the secret-location table                                                                                                                                                                                                                                                                                                                                                                                                                                                          | `agent_docs/env-vars.md`                                                                                                                                                                                                                                                                                                                                                                                                                                                | `Full list: agent_docs/env-vars.md`                                                    |
...
- `agent_docs/memory_archive/2026-07.md` — Qt/Windows UI gotchas, autostart + single-instance history (archived 2026-07-30)
```
